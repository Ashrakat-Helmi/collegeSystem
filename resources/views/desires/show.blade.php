            ...
            <div class="card-body bg-dark text-white">
                <div class="card-body">
                    ...
                    <div class="container d-flex justify-content-around">
                        <a href="{{ route('desiress.edit', $desires->id) }}" class="w-25 btn btn-success"><i class="text-light fa-solid fa-pen-to-square"></i> | Edit</a>
                        <a href="{{ route('desiress.destroy', $desires->id) }}" class="w-25 btn btn-danger"><i class="text-light fa-solid fa-trash"></i> | Delete</a>
                        <a href="{{ route('desiress.index') }}" class="w-25 btn btn-light"><i class="text-dark fas fa-next"></i> | Go Back</a>
                    </div>
                </div>
            </div>
        </div>
