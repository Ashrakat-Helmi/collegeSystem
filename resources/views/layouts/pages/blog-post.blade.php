        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="member">
                        ...
                        <div class="member-info">
                            <p>
                                The head of the department congratulates the distinguished students for obtaining the
                                first places
                            </p>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ asset('assets/img/news/img2.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <p>
                                A souvenir photo with the graduating students with a group of professors and doctors at
                                the university
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ asset('assets/img/news/img3.jpg') }}" class="img-fluid" alt="">

                        </div>
                        <div class="member-info">
                            <p>
                                A souvenir photo with graduating students from the FMI program with elite community
                                stars
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ asset('assets/img/news/img4.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <p>
                                The professor, the director of the college celebrates with the students the beginning of
                                the new year
                            </p>
                        </div>
                    </div>
                ...
                <ul>
                    <li data-aos="fade-up">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                            class="collapse" data-bs-target="#faq-list-1">Where is Helwan University <i
