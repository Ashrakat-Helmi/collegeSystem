                    ...
                    <div class="card-body">
                        <form action="{{ route('user.create') }}" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <span class="text-danger">@error('englishDegree')
                                        {{ $message }}
                                    @enderror</span>
                            </div>
                            <div class="form-group">
                                <label for="highSchoolTotalMarks">High School Total Marks</label>
                                <input type="number" min="180" max="300" name="highSchoolTotalMarks" class="form-control"
                                    value="{{ old('highSchoolTotalMarks') }}, 180" placeholder="Enter Your High School Total Marks">
                                <span class="text-danger">@error('highSchoolTotalMarks')
                                        {{ $message }}
                                    @enderror</span>
                            </div>
                            <div class="form-group">
